...
Misael: Diseña las clases JPA (Mascota, Dueño, Cita, Veterinario), Añade relaciones simples, Integra la Dog/Cat API para mostrar imagenes de mascotas y colabora en las pruebas de los datos que llegan al dashborad.